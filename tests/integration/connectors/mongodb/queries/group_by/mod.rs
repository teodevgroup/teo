...
async fn group_by_returns_empty_array_if_no_record() {
    ...
    let res = request(&app, "records", "group-by", teon!({
        "by": ["country"],
    })).await;
...
async fn group_by_returns_grouped_value_for_single_field() {
    let app = test::init_service(app().await).await;
    let _id1 = request_get(&app, "records", "create", teon!({
        "create": {
            "country": "US",
            "city": "Washington",
            "profileViews": 5000
    ...
    let _id2 = request_get(&app, "records", "create", teon!({
        "create": {
            "country": "US",
            "city": "Los Angeles",
            "profileViews": 5000
    ...
    let _id3 = request_get(&app, "records", "create", teon!({
        "create": {
            "country": "UK",
            "city": "London",
            "profileViews": 5000
...
async fn group_by_returns_grouped_value_for_multiple_fields() {
    ...
    let _id4 = request_get(&app, "records", "create", teon!({
        "create": {
            "country": "UK",
            "city": "London",
            "profileViews": 5000
