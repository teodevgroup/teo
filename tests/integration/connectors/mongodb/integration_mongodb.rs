...
async fn create_with_duplicated_unique_value_cannot_create() {
    let app = test::init_service(app().await).await;
    let req1 = test::TestRequest::post().uri("/simples/action").set_json(tson!({
        "action": "Create",
        "create": {
            "uniqueString": "1",
            "requiredString": "1"
    ...
    let req2 = test::TestRequest::post().uri("/simples/action").set_json(tson!({
        "action": "Create",
        "create": {
            "uniqueString": "1",
            "requiredString": "1"
...
async fn find_unique_can_find_by_primary_key() {
    let app = test::init_service(app().await).await;
    let create_req = test::TestRequest::post().uri("/simples/action").set_json(tson!({
        "action": "Create",
        "create": {
            "uniqueString": "1",
            "requiredString": "1",
...
async fn find_unique_can_find_by_compound_unique_key() {
    let app = test::init_service(app().await).await;
    let create_req = test::TestRequest::post().uri("/compounds/action").set_json(tson!({
        "action": "Create",
        "create": {
            "one": "1",
            "two": "2",
    ...
    let _: ServiceResponse = test::call_service(&app, create_req).await;
    let find_unique_req = test::TestRequest::post().uri("/compounds/action").set_json(tson!({
        "action": "FindUnique",
        "where": {
            "one": "1",
            "two": "2"
...
async fn find_many_can_find_all() {
    ...
    let _: ServiceResponse = test::call_service(&app, create_req).await;
    let find_many_req = test::TestRequest::post().uri("/compounds/action").set_json(tson!({
        "action": "FindMany"
    })).to_request();
...
async fn delete_can_delete_record() {
    ...
    assert!(is_object_id(id_str));
    // now find many
    let find_many_req = test::TestRequest::post().uri("/simples/action").set_json(tson!({
        "action": "FindMany"
    })).to_request();
    let resp: ServiceResponse = test::call_service(&app, find_many_req).await;
    assert!(resp.status().is_success());
...
async fn create_vec_works_with_inner_pipeline() {
    let app = test::init_service(app().await).await;
    let req = test::TestRequest::post().uri("/lists/action").set_json(tson!({
        "action": "Create",
        "create": {
            "listOne": ["1", "2"],
        }
