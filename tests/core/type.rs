...
async fn i8_input_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"i8": 2})).await;
...
async fn i8_output_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"i8": 3})).await;
    let json_output = simple.to_json();
...
async fn i16_input_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"i16": 2})).await;
...
async fn i16_output_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"i16": 3})).await;
    let json_output = simple.to_json();
...
async fn i128_input_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"i128": 2})).await;
...
async fn i128_output_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"i128": 3})).await;
    let json_output = simple.to_json();
...
async fn u8_input_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u8": 2})).await;
...
async fn u8_output_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u8": 3})).await;
    let json_output = simple.to_json();
...
async fn u16_input_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u16": 2})).await;
...
async fn u16_output_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u16": 3})).await;
    let json_output = simple.to_json();
...
async fn u32_input_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u32": 2})).await;
...
async fn u32_output_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u32": 3})).await;
    let json_output = simple.to_json();
...
async fn u64_input_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u64": 2})).await;
...
async fn u64_output_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u64": 3})).await;
    let json_output = simple.to_json();
...
async fn u128_input_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u128": 2})).await;
...
async fn u128_output_is_number() {
    let graph = make_graph().await;
    let simple = graph.create_object("Simple", teon!({})).unwrap();
    let _ = simple.set_tson(&teon!({"u128": 3})).await;
    let json_output = simple.to_json();
