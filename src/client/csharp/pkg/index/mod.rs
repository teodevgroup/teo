...
use crate::client::csharp::pkg::index::doc::{action_doc, create_or_update_doc, credentials_doc, cursor_doc, field_doc, include_doc, nested_connect_doc, nested_create_doc, nested_create_or_connect_doc, nested_delete_doc, nested_disconnect_doc, nested_set_doc, nested_update_doc, nested_upsert_doc, order_by_doc, page_number_doc, page_size_doc, relation_doc, select_doc, skip_doc, take_doc, unique_connect_create_doc, unique_connect_doc, unique_where_doc, where_doc, where_doc_first};
            ...
            graph.models().iter().for_each(|m| {
                if m.actions().len() > 0 {
                    ...
                    c.block(format!("public class {model_class_name}Delegate : Delegate {{"), |b| {
                        ...
                        b.empty_line();
                        b.block(format!("protected {model_class_name}Delegate(string? token = null) {{"), |b| {
                            b.line("_Token = token;");
                        }, "}");
                        ActionType::iter().for_each(|a| {
